...
import Image2 from "../assets/pic1.webp";
const Home = () => {
  return (
    <div
      class="relative top-25 bg-cover bg-center h-[500px]"
    ...
    >
      ...
      <div>
        ...
        <strong className="text-yellow-500 text-3xl ml-40">
          100% Organic Foods
        </strong>
        <h1 class="text-6xl font-bold text-green-600 mt-10 ">
        ...
        <img src={Image2 } alt="ys" className="w-70 rounded-lg shadow-md" />
      </div>
