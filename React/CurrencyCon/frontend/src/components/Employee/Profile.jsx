      ...
      <Section title="Employment Details" icon={<FiBriefcase size={20} />}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <InfoCard
            ...
            title="Department"
            value={user.jobDetail?.department}
          />
          <InfoCard
            icon={<FaUserTie size={18} />}
            title="Designation"
            value={user.jobDetail?.designation}
          />
          <InfoCard
            icon={<FiCalendar size={18} />}
            title="Hiring Date"
            value={user.jobDetail?.hiringDate}
          />
          <InfoCard
            icon={<GiTakeMyMoney size={18} />}
            title="Salary"
            value={`₹ ${user.jobDetail?.salary}`}
          />
          <InfoCard
            icon={<GrStatusGood size={18} />}
            title="Status"
            value={user.jobDetail?.status}
          />
          <InfoCard
            icon={<FaUserTie size={18} />}
            title="Role"
            value={user.jobDetail?.role}
          />
          <InfoCard
            icon={<FiClock size={18} />}
            title="Shift Time"
            value={`${user.jobDetail?.shiftStartTime} - ${user.jobDetail?.shiftEndTime}`}
          />
          <InfoCard
            icon={<MdOutlineWeekend size={18} />}
            title="Week Off"
            value={user.jobDetail?.weekOff}
          />
          <InfoCard
            icon={<FaUserTie size={18} />}
            title="Manager Name"
            value={user.jobDetail?.ManagerName}
          />
          <InfoCard
            icon={<FiMail size={18} />}
            title="Manager Email"
            value={user.jobDetail?.ManagerEmail}
          />
        </div>
      </Section>
    </div>
